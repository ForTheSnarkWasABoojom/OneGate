using FakeItEasy;
using OneGate.Backend.Core.Asset.Service;
using OneGate.Backend.Core.Asset.Service.Repository;
...
namespace OneGate.Backend.Services.Asset.Service.Tests
{
    public class AssetServiceTests
    {
        ...
        public AssetServiceTests()
        {
            ...
            _service = new AssetService(_assetsRepository, _exchangesRepository,_layoutRepository);
        }
