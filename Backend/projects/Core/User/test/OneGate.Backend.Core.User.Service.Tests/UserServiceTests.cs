...
namespace OneGate.Backend.Core.User.Service.Tests
{
    public class UserServiceTests
    {
        ...
        public UserServiceTests()
        {
            ...
            _service = new UserService(_accountRepository, _orderRepository, _portfolioRepository, _portfolioAssetLinkRepository);
        }
